...
//        String uri = "magnet:?xt=urn:btih:5AED284F944E5DE2A50142842119029858C91789&dn=Rick.and.Morty.S04E03.WEBRip.x264-TBS";
        ...
        boolean r = signal.await(20, TimeUnit.SECONDS);
        if (!r) {
